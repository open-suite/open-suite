...
# MijnBureau chart:
#   - https://DOMAIN serves the portal, same as https://bridge.DOMAIN.
...
echo "==> Adding root portal alias https://${DOMAIN}"
...
metadata:
  ...
  annotations:
    ...
    traefik.ingress.kubernetes.io/router.middlewares: mb-bureaublad-hsts-header@kubernetescrd
spec:
