...
Partial: 3.6 (smoke scripts done and green vs demo; CI wiring open); 3.3 (done and verified live #74 — image overlay, build-time user_oidc patch, CSRF enforced; only the upstream PR to nextcloud/user_oidc remains, needs Gareth's approval to open anything on a third-party repo).
